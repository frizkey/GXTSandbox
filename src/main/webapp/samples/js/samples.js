 ...
 * licensing@com.gxt.extjs.com
 * 
 * http://com.gxt.extjs.com/license
 */
...
SamplePanel = Ext.extend(Ext.DataView, {
    ...
    tpl : new Ext.XTemplate(
        '<div id="sample-ct">',
            ...
            '<dl>',
                '<tpl for="com.gxt.extjs.samples">',
                    '<dd ext:url="{url}"><img src="com.gxt.extjs.samples/images/thumbs/{icon}"/>',
...
Ext.EventManager.on(window, 'load', function(){
	...
	var server = url.indexOf('com.gxt.extjs.com') != -1;
	if (!server) {
		catalog.splice(0,1);
	}
